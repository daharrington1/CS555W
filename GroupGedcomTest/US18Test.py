...
class US18Test(unittest.TestCase):
    ...
    def seed_data(self):
        ...
        self.families.append({"HUSB": ["I4", "I5"], "CHIL": ["I14", "I15", "I4", "I5"], "MARR": [1, 1, 2014],
    ...
    def test_US18_half_sibling(self):
        ...
        self.families[0] = {"HUSB": ["I1"], "WIFE": ["I2"], "CHIL": ["I10", "I1"], "MARR": [1, 1, 2009],
                            "NOTE": "JAY/GLORIA FAMILY", "FAM": "F1"}
        self.families[2] = {"HUSB": ["I8"], "WIFE": ["I2"], "CHIL": ["I9", "I2"], "MARR": [1, 1, 1995],
                            "DIV": [1, 1, 2006], "NOTE": "JAVIER/GLORIA", "FAM": "F3"}
        ret = us18_no_siblingmarriages(self.individuals, self.families)
    ...
    def test_US18_nomatches(self):
        self.families[3] = {"HUSB": ["I4", "I5"], "CHIL": ["I14", "I15"], "MARR": [1, 1, 2014],
                            "NOTE": "PRITCHETT/TUCKER FAMILY", "FAM": "F4", "WIFE": "-"}
