...
class usruntest(unittest.TestCase):
    ...
    def seed_data(self):
        ...
        self.families.append({"HUSB":["I4","I5"],"CHIL":["I14","I15"],"MARR":[1,1,2014],"NOTE":"PRITCHETT/TUCKER FAMILY","FAM":"F4","WIFE":"-"})
    ...
    def test_uf(self):
        ...
        tmpfam.append({"HUSB":["I1"],"WIFE":["I2"],"CHIL":["I10"],"MARR":[1,1,2009],"NOTE":"JAY/GLORIA FAMILY","FAM":"F12"})
        ...
        tmpfam.append(
            {"HUSB": ["I1"], "WIFE": ["I2"], "CHIL": ["I10"], "MARR": [1, 1, 2009], "NOTE": "JAY/GLORIA FAMILY",
             "FAM": "F12"})
        self.assertEqual(unique_families(tmpfam, self.individuals), [('1/1/2009', 'F1', 'F12'),('1/1/2009', 'F1', 'F12'),('1/1/2009', 'F12', 'F12')])
    ...
    def test_mb(self):
        ...
        self.assertEqual(multiple_births(tmpfam, self.individuals), [('4/1/2013', 'F1', ['I10', 'I10']), ('8/5/2019', 'F10', ['I22', 'I23'])])
        ...
        tmpfam[0]['CHIL'].append('I1')
        self.assertEqual(multiple_births(tmpfam, self.individuals), [('4/1/2013', 'F1', ['I10', 'I10']), ('28/12/2021', 'F1', ['I1', 'I1'])])
        tmpfam[0]['CHIL'].append('I1')
