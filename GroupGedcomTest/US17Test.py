...
class US17Test(unittest.TestCase):
    ...
    def test_US17_noinputs(self):
        ...
        with self.assertRaises(Exception) as context:
            ret = us17_no_marr2child(None, None)

        with self.assertRaises(Exception) as context:
            ret = us17_no_marr2child(self.families)

        with self.assertRaises(Exception) as context:
            ret = us17_no_marr2child(self.individuals)
    ...
    def test_US17_2family(self):
        ...
        self.individuals[12] = {"NAME": "Lorraine/Dunphy/", "SEX": "F", "BIRT": [1, 1, 1965], "FAMS": ["F8", "F7"],
                                "AGE": 55, "INDI": "I12"}
        self.families[6] = {"HUSB": ["I11"], "WIFE": ["I13"], "CHIL": ["I7", "I12"], "MARR": [1, 1, 1965],
                            "NOTE": "FRANK/GRACE FAMILY", "FAM": "F7"}
    ...
    def test_US17_2family_text(self):
        ...
        expected_ret = [{'Spouse': 'I11', 'MySpouse': 'I12', 'FAM': 'F8', 'MyChildren': ['I7', 'I12']},
                        {'Spouse': 'I27', 'MySpouse': 'I26', 'FAM': 'F11', 'MyChildren': ['I26']}]
        ret = us17_no_marr2child(self.individuals, self.families)
        self.assertListEqual(expected_ret, ret, "Expected Return does not match")
    ...
    def test_US17_3family_text(self):
        ...
        self.families[6] = {"HUSB": ["I11"], "WIFE": ["I13"], "CHIL": ["I7", "I12"], "MARR": [1, 1, 1965],
                            "NOTE": "FRANK/GRACE FAMILY", "FAM": "F7"}
        self.families[3] = {"HUSB": ["I4", "I5"], "CHIL": ["I14", "I15", "I5"], "MARR": [1, 1, 2014],
                            "NOTE": "PRITCHETT/TUCKER FAMILY", "FAM": "F4", "WIFE": "-"}

        expected_ret = [{'Spouse': 'I4', 'MySpouse': 'I5', 'FAM': 'F4', 'MyChildren': ['I14', 'I15', 'I5']},
                        {'Spouse': 'I11', 'MySpouse': 'I12', 'FAM': 'F8', 'MyChildren': ['I7', 'I12']},
                        {'Spouse': 'I27', 'MySpouse': 'I26', 'FAM': 'F11', 'MyChildren': ['I26']}]
        ret = us17_no_marr2child(self.individuals, self.families)
        self.assertListEqual(expected_ret, ret, "Expected Return does not match")
    ...
    def test_US17_nomatches(self):
        ...
        self.families[10] = {"HUSB": ["I26"], "WIFE": ["I27"], "CHIL": ["I3"], "MARR": [16, 1, 2018],
                             "NOTE": "MarryToChildFAMILY", "FAM": "F11"}
