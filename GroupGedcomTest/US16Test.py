...
class US16Test(unittest.TestCase):
    ...
    def test_US16_1family(self):
        ...
        self.families[9] = {"HUSB": ["I21"], "WIFE": ["I20"], "CHIL": ["I22", "I21"], "MARR": [8, 3, 2019],
                            "FAM": "F10", "NOTE": "MARSHALL/DUNPHY FAMILY"}
    ...
    def test_US16_2family_text(self):
        ...
        expected_ret = [{'FAM': 'F4', 'LNAMES': ['Pritchett', 'Tucker', 'Tucker-Pritchett']},
                        {'FAM': 'F10', 'LNAMES': ['Marshall', 'Hastings']}]
        ret = us16_male_last_names(self.individuals, self.families)
    ...
    def test_US16_nomatches(self):
        ...
        self.families[9] = {"HUSB": ["I21"], "WIFE": ["I20"], "CHIL": ["I22", "I21"], "MARR": [8, 3, 2019],
                            "FAM": "F10", "NOTE": "MARSHALL/DUNPHY FAMILY"}
        self.individuals[4] = {"NAME": "Cameron/Pritchett/", "SEX": "M", "BIRT": [29, 2, 1972], "FAMS": ["F4"],
                               "FAMC": ["F5"], "AGE": 48, "INDI": "I5"}
        self.individuals[14] = {"NAME": "Lily/Pritchett/", "SEX": "F", "BIRT": [19, 2, 2008], "FAMC": ["F4"], "AGE": 12,
                                "INDI": "I14"}
        self.individuals[15] = {"NAME": "Rexford/Pritchett/", "SEX": "M", "BIRT": [1, 4, 2020], "FAMC": ["F4"],
                                "AGE": 0, "INDI": "I15"}
        self.individuals[16] = {"NAME": "Merle/Pritchett/", "SEX": "M", "BIRT": [1, 1, 1943], "FAMS": ["F5"], "AGE": 77,
                                "INDI": "I16"}
